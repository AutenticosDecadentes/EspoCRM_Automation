...
def test_buscar_usuario_por_email_encontrado(get_headers):
    response = Authentication().authenticate_valid_user(get_headers,
                                                        Endpoint.BUSCAR_USUARIOS(where="201604461@est.umss"), 'GET')
    AssertionSchemas().assert_status_code(response, 200)
    AssertionSchemas().assert_usuarios_buscar_schema_file(response.json())
...
@pytest.mark.functional
def test_buscar_usuario_por_email_encontrado(get_headers):
    response = Authentication().authenticate_valid_user(get_headers, Endpoint.BUSCAR_USUARIOS(where="mnbmbmbjkhghjjjg"),
                                                        'GET')
    AssertionSchemas().assert_status_code(response, 200)
    AssertionSchemas().assert_usuarios_buscar_schema_file(response.json())
...
def test_buscar_usuario_por_email_encontrado(get_headers):
    response = Authentication().authenticate_valid_user(get_headers,
                                                        Endpoint.BUSCAR_USUARIOS(where="apellido_no_valido"), 'GET')
    AssertionSchemas().assert_status_code(response, 200)
    AssertionSchemas().assert_usuarios_buscar_schema_file(response.json())
...
def test_buscar_usuario_por_email_encontrado(get_headers):
    response = Authentication().authenticate_valid_user(get_headers,
                                                        Endpoint.BUSCAR_USUARIOS(where="username_no_valido"), 'GET')
    AssertionSchemas().assert_status_code(response, 200)
    AssertionSchemas().assert_usuarios_buscar_schema_file(response.json())
...
def test_buscar_usuario_por_email_no_valido(get_headers):
    response = Authentication().authenticate_valid_user(get_headers, Endpoint.BUSCAR_USUARIOS(where="email_no_valido"),
                                                        'GET')
    AssertionSchemas().assert_status_code(response, 200)
    AssertionSchemas().assert_usuarios_buscar_schema_file(response.json())
